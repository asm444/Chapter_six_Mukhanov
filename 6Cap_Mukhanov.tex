...
Wronskiano\\ $W (\delta_1, \delta_2) = \dot{\delta_1}\delta_2 - \dot{\delta_2}\delta_1 = C e^{\int P(x)dx}$ para $\ddot{\delta} + P(x)\dot{\delta} + Q(x) \delta = 0$ e manipulando a equação (\hyperref[eq64]{64}), encontrando o P(x), temos

$$P(x) = \dfrac{3x}{2}\dfrac{(1+ (1-w)x^{-3w})}{x^2 (1+x^{-3w})} = \dfrac{3}{2x}\left(1 - \dfrac{wx^{-3w}}{(1+x^{-3w})}\right)$$

calculando $\int P(x)dx$, obtemos

$$\int P(x)dx = \int \dfrac{3}{2x}\left(1 - \dfrac{wx^{-3w}}{(1+x^{-3w})}\right)dx = \dfrac{3}{2}\int\dfrac{1}{x}dx + \dfrac{1}{2}\int\dfrac{-wwx^{-3w-1}}{(1+x^{-3w})}dx$$

$$\int P(x)dx = \dfrac{3}{2}\ln{x} + \dfrac{1}{2}\ln{(1+x^{-3w})}$$

$$\dot{\delta_1}\delta_2 - \dot{\delta_2}\delta_1  = ce^{-\left(\dfrac{3}{2}\ln{x} + \dfrac{1}{2}\ln{(1+x^{-3w})} \right)}$$

$$\dot{\delta_1}\delta_2 - \dot{\delta_2}\delta_1 = \dfrac{c}{x^{3/2}(1+x^{-3w})^{1/2}}$$

$$\dot{\delta_1}\delta_2 - \dot{\delta_2}\delta_1 = \dfrac{c}{x^{3/2}(1+x^{3})^{1/2}}$$
