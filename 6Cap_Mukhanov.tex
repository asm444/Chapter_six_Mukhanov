...
ao fator de escala. Portanto, se quisermos obter grandes inomogeneidades δ 1
hoje, temos que assumir que nos primeiros tempos (por exemplo, em redshifts z = 1000) o
as inomogeneidades já eram substanciais (δ 10−3). Isso impõe bastante forte
restrições no espectro inicial de perturbações. Veremos no Capítulo 8 que
o espectro inicial necessário pode ser explicado naturalmente na cosmologia inflacionária.
