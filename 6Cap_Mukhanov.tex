...
Wronskiano\\ $W (\delta_1, \delta_2) = \dot{\delta_1}\delta_2 - \dot{\delta_2}\delta_1 = C e^{\int P(x)dx}$ para $\ddot{\delta} + P(x)\dot{\delta} + Q(x) \delta = 0$ e manipulando a equação (64), encontrando o P(x), temos
